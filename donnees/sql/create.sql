...
ALTER TABLE situer_parkings ADD CONSTRAINT situer_parkings_parking_parkings_id FOREIGN KEY (parking) REFERENCES parkings(id) ON DELETE CASCADE;
ALTER TABLE situer_parkings ADD CONSTRAINT situer_parkings_coordonnee_coordonnees_parkings_id FOREIGN KEY (coordonnee) REFERENCES coordonnees_parkings(id) ON DELETE CASCADE;
ALTER TABLE pts_recharge ADD CONSTRAINT pts_recharge_parking_correspondant_parkings_id FOREIGN KEY (parking_correspondant) REFERENCES parkings(id) ON DELETE CASCADE;
ALTER TABLE situer_pts_recharge ADD CONSTRAINT situer_pts_recharge_point_de_recharge_pts_recharge_id FOREIGN KEY (point_de_recharge) REFERENCES pts_recharge(id) ON DELETE CASCADE;
ALTER TABLE situer_pts_recharge ADD CONSTRAINT situer_pts_recharge_coordonnee_coordonnees_pts_recharge_id FOREIGN KEY (coordonnee) REFERENCES coordonnees_pts_recharge(id) ON DELETE CASCADE;
ALTER TABLE compatible ADD CONSTRAINT compatible_type_de_prise_types_de_prises_id FOREIGN KEY (type_de_prise) REFERENCES types_de_prises(id) ON DELETE CASCADE;
ALTER TABLE compatible ADD CONSTRAINT compatible_point_de_recharge_pts_recharge_id FOREIGN KEY (point_de_recharge) REFERENCES pts_recharge(id) ON DELETE CASCADE;
ALTER TABLE recharger ADD CONSTRAINT recharger_puissance_puissances_id FOREIGN KEY (puissance) REFERENCES puissances(id) ON DELETE CASCADE;
ALTER TABLE recharger ADD CONSTRAINT recharger_point_de_recharge_pts_recharge_id FOREIGN KEY (point_de_recharge) REFERENCES pts_recharge(id) ON DELETE CASCADE;
ALTER TABLE pts_covoit ADD CONSTRAINT pts_covoit_parking_correspondant_parkings_id FOREIGN KEY (parking_correspondant) REFERENCES parkings(id) ON DELETE CASCADE;
ALTER TABLE situer_pts_covoit ADD CONSTRAINT situer_pts_covoit_point_de_covoiturage_pts_covoit_id FOREIGN KEY (point_de_covoiturage) REFERENCES pts_covoit(id) ON DELETE CASCADE;
ALTER TABLE situer_pts_covoit ADD CONSTRAINT situer_pts_covoit_coordonnee_coordonnees_pts_covoit_id FOREIGN KEY (coordonnee) REFERENCES coordonnees_pts_covoit(id) ON DELETE CASCADE;
ALTER TABLE situer_stations_velo ADD CONSTRAINT situer_stations_velo_pt_velo_stations_velo_id FOREIGN KEY (pt_velo) REFERENCES stations_velo(id) ON DELETE CASCADE;
ALTER TABLE situer_stations_velo ADD CONSTRAINT situer_stations_velo_coordonnee_coordonnees_stations_velo_id FOREIGN KEY (coordonnee) REFERENCES coordonnees_stations_velo(id) ON DELETE CASCADE;
ALTER TABLE installer ADD CONSTRAINT installer_station_velo_stations_velo_id FOREIGN KEY (station_velo) REFERENCES stations_velo(id) ON DELETE CASCADE;
ALTER TABLE installer ADD CONSTRAINT installer_type_accroche_types_accroches_velo_id FOREIGN KEY (type_accroche) REFERENCES types_accroches_velo(id) ON DELETE CASCADE;
ALTER TABLE pistes_velo ADD CONSTRAINT pistes_velo_type_piste_types_pistes_velo_id FOREIGN KEY (type_piste) REFERENCES types_pistes_velo(id) ON DELETE CASCADE;
ALTER TABLE situer_pistes_velo ADD CONSTRAINT situer_pistes_velo_piste_velo_pistes_velo_id FOREIGN KEY (piste_velo) REFERENCES pistes_velo(id) ON DELETE CASCADE;
ALTER TABLE situer_pistes_velo ADD CONSTRAINT situer_pistes_velo_coordonnee_coordonnees_pistes_velo_id FOREIGN KEY (coordonnee) REFERENCES coordonnees_pistes_velo(id) ON DELETE CASCADE;
ALTER TABLE lignes_cars ADD CONSTRAINT lignes_cars_depart_arrets_cars_id FOREIGN KEY (depart) REFERENCES arrets_cars(id) ON DELETE CASCADE;
ALTER TABLE lignes_cars ADD CONSTRAINT lignes_cars_destination_arrets_cars_id FOREIGN KEY (destination) REFERENCES arrets_cars(id) ON DELETE CASCADE;
ALTER TABLE situer_lignes_cars ADD CONSTRAINT situer_lignes_cars_ligne_car_lignes_cars_id FOREIGN KEY (ligne_car) REFERENCES lignes_cars(id) ON DELETE CASCADE;
ALTER TABLE situer_lignes_cars ADD CONSTRAINT situer_lignes_cars_coordonnee_coordonnees_lignes_cars_id FOREIGN KEY (coordonnee) REFERENCES coordonnees_lignes_cars(id) ON DELETE CASCADE;
ALTER TABLE situer_arrets_cars ADD CONSTRAINT situer_arrets_cars_arret_car_arrets_cars_id FOREIGN KEY (arret_car) REFERENCES arrets_cars(id) ON DELETE CASCADE;
ALTER TABLE situer_arrets_cars ADD CONSTRAINT situer_arrets_cars_coordonnee_coordonnees_arrets_cars_id FOREIGN KEY (coordonnee) REFERENCES coordonnees_arrets_cars(id) ON DELETE CASCADE;
ALTER TABLE desservir_car ADD CONSTRAINT desservir_car_ligne_car_lignes_cars_id FOREIGN KEY (ligne_car) REFERENCES lignes_cars(id) ON DELETE CASCADE;
ALTER TABLE desservir_car ADD CONSTRAINT desservir_car_arret_car_arrets_cars_id FOREIGN KEY (arret_car) REFERENCES arrets_cars(id) ON DELETE CASCADE;
ALTER TABLE situer_gares_ter ADD CONSTRAINT situer_gares_ter_gare_ter_gares_ter_id FOREIGN KEY (gare_ter) REFERENCES gares_ter(id) ON DELETE CASCADE;
ALTER TABLE situer_gares_ter ADD CONSTRAINT situer_gares_ter_coordonnee_coordonnees_gares_ter_id FOREIGN KEY (coordonnee) REFERENCES coordonnees_gares_ter(id) ON DELETE CASCADE;
ALTER TABLE situer_pt_freefloat ADD CONSTRAINT situer_pt_freefloat_pt_freefloat_pt_freefloat_id FOREIGN KEY (pt_freefloat) REFERENCES pt_freefloat(id) ON DELETE CASCADE;
ALTER TABLE situer_pt_freefloat ADD CONSTRAINT situer_pt_freefloat_coordonnee_coordonnees_pt_freefloat_id FOREIGN KEY (coordonnee) REFERENCES coordonnees_pt_freefloat(id) ON DELETE CASCADE;
ALTER TABLE autoriser ADD CONSTRAINT autoriser_pt_freefloat_pt_freefloat_id FOREIGN KEY (pt_freefloat) REFERENCES pt_freefloat(id) ON DELETE CASCADE;
ALTER TABLE autoriser ADD CONSTRAINT autoriser_vehicule_vehicules_freefloating_id FOREIGN KEY (vehicule) REFERENCES vehicules_freefloating(id) ON DELETE CASCADE;
ALTER TABLE situer_stations_vcube ADD CONSTRAINT situer_stations_vcube_station_vcube_stations_vcube_id FOREIGN KEY (station_vcube) REFERENCES stations_vcube(id) ON DELETE CASCADE;
ALTER TABLE situer_stations_vcube ADD CONSTRAINT situer_stations_vcube_coordonnee_coordonnees_stations_vcube_id FOREIGN KEY (coordonnee) REFERENCES coordonnees_stations_vcube(id) ON DELETE CASCADE;
ALTER TABLE arrets ADD CONSTRAINT arrets_station_vcube_proximite_stations_vcube_id FOREIGN KEY (station_vcube_proximite) REFERENCES stations_vcube(id) ON DELETE CASCADE;
ALTER TABLE situer_arrets ADD CONSTRAINT situer_arrets_arret_arrets_id FOREIGN KEY (arret) REFERENCES arrets(id) ON DELETE CASCADE;
ALTER TABLE situer_arrets ADD CONSTRAINT situer_arrets_coordonnee_coordonnees_arrets_id FOREIGN KEY (coordonnee) REFERENCES coordonnees_arrets(id) ON DELETE CASCADE;
ALTER TABLE lignes ADD CONSTRAINT lignes_direction_arrets_id FOREIGN KEY (direction) REFERENCES arrets(id) ON DELETE CASCADE;
ALTER TABLE lignes ADD CONSTRAINT lignes_type_types_lignes_id FOREIGN KEY (type) REFERENCES types_lignes(id) ON DELETE CASCADE;
ALTER TABLE situer_lignes ADD CONSTRAINT situer_lignes_ligne_lignes_id FOREIGN KEY (ligne) REFERENCES lignes(id) ON DELETE CASCADE;
ALTER TABLE situer_lignes ADD CONSTRAINT situer_lignes_coordonnee_coordonnees_lignes_id FOREIGN KEY (coordonnee) REFERENCES coordonnees_lignes(id) ON DELETE CASCADE;
ALTER TABLE desservir ADD CONSTRAINT desservir_arret_arrets_id FOREIGN KEY (arret) REFERENCES arrets(id) ON DELETE CASCADE;
ALTER TABLE desservir ADD CONSTRAINT desservir_ligne_lignes_id FOREIGN KEY (ligne) REFERENCES lignes(id) ON DELETE CASCADE;
