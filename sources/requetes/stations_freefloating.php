...
")) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        $result2 = $db->query("SELECT DISTINCT vehicules_freefloating.vehicule FROM vehicules_freefloating INNER JOIN autoriser ON vehicules_freefloating.id = autoriser.vehicule WHERE pt_freefloat = ".$row['id'].";");
