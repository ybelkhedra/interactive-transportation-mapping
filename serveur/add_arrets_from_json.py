...
for i in range (0,taille):
    try :
        ...
        dico_arret = {'nom':arret_nom,'lat':arret_lat,'lon':arret_lon,'vehicule':arret_vehicule}
        lignes_arret = []
        ...
        print("Erreur lors du traitement de l'arret")
...
for i in range (0,len(lignesData['features'])):
    try :    
        ...
        dico_ligne = {'nom':ligne_nom_commercial,'vehicule':ligne_vehicule,'arrets':liste_arrets}
        LISTE_LIGNES.append(dico_ligne)
    except :
        print("Erreur lors du traitement de la ligne")
...
with open('../donnees/json/resultats_post_traitement/lignes.json', 'w') as outfile:
    json.dump(LISTE_LIGNES, outfile)
